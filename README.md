...
`; break;
    ...
    case 6: box.innerHTML+=`<h2>Jour 6</h2><p>Recette pour un apéro réussi 🍽️ : <a href='https://www.marmiton.org/recettes/recette_sapin-feuillete-au-pesto_383379.aspx' target='_blank'>Sapin feuilleté au pesto</a></p>`; break;
    case 7: box.innerHTML+=`<h2>Jour 7</h2><p>Une autre recette pour l'apéro : <a href='https://www.marmiton.org/recettes/recette_gougeres-au-fromage_20095.aspx' target='_blank'>Gougères au fromage</a></p>`; break;
    ...
    case 12: box.innerHTML+=`<h2>Jour 12</h2><p>En lumière : nous avons 2 ruches aux Marsauderies pour la biodiversité 🍯🐝 et nous avons reçu des pots de miel.<p>Quiz : à votre avis, combien une abeille produit-elle de miel au cours de sa vie ? (g)</p>
        ...
        <hr>`;
        break;
    case 13: box.innerHTML+=`<h2>Jour 13</h2><p>Recette de Noël : <a href='https://www.marmiton.org/recettes/recette_huitres-gratinees-au-parmesan_56242.aspx' target='_blank'>Huîtres gratinées</a></p>`; break;
    ...
    case 20: box.innerHTML+=`<h2>Jour 20</h2><p>Recette vin chaud : <a href='https://www.marmiton.org/recettes/recette_vin-chaud-aux-epices_25224.aspx' target='_blank'>Vin chaud aux épices</a></p>`; break;
